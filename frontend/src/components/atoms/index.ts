...
export { default as EnvelopeIcon } from './svg/EnvelopeIcon'
export { default as SurveyIcon } from './svg/SurveyIcon'
export { default as DashboardIcon } from './svg/DashboardIcon'
