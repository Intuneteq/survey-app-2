...
export default function Login() {
    ...
    return (
        <section className="py-20 xl:py-24 w-full">
            ...
            <article className="mt-[6.44rem] mb-[3.75rem]">
                        ...
                        <div className="flex-col space-y-[1.16rem]">
                            ...
                            <div className="text-right text-primary">
                                <Link to={"/forgotpassword"}>
                                    <p className="text-[0.875rem] font-[400] leading-normal hover:text-[#BAB286]">
                                        Forgot Password?
                                    </p>
                                </Link>
                            </div>
                        </div>
                        <div className="w-full justify-center space-y-[0.5rem] mt-[6rem]">
