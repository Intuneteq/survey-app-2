    ...
    <div className="">
            ...
            <div>
                ...
                <div className="space-y-[1.88rem] px-[7.88rem] py-[3.12rem] ">
                  <div className="flex items-center ">
                    <input
                      ...
                      name="Lorem ipsum"
                    />
                    <p className="pl-[1.25rem]">Lorem ipsum</p>
                  </div>
                  <div className="flex items-center ">
                    <input
                      className="w-[1.5625rem] h-[1.5625rem] "
                      ...
                      name="Lorem ipsum"
                    />
                    <p className="pl-[1.25rem]">Lorem ipsum dolor</p>
                  </div>
                  <div className="flex items-center ">
                    <input
                      className="w-[1.5625rem] h-[1.5625rem] "
                      ...
                      name="Lorem ipsum"
                    />
                    <p className="pl-[1.25rem]">Lorem ipsum dolor sit amet</p>
                  </div>
                  <div className="flex items-center ">
                    <input
                      className="w-[1.5625rem] h-[1.5625rem] "
              ...
              <div className="flex justify-between px-[4.06rem] mt-[3.29rem] ">
                ...
                <div className="flex space-x-[1.19rem]">
                  <button className="p-[0.31rem]">PREVIOUS</button>
                  <button className="p-[0.31rem]">NEXT</button>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="flex justify-end space-x-[0.62rem] pt-[5rem]">
        <button className="w-[4rem] h-[4rem]">
          <img className="object-contain w-full h-full" src={leftarrow} />
        </button>
        <button className="w-[4rem] h-[4rem] bg-[#239D60] rounded-[0.375rem]">
          1
        </button>
        <button className="w-[4rem] h-[4rem] rounded-[0.375rem]">2</button>
        <button className="w-[4rem] h-[4rem] rounded-[0.375rem]">3</button>
        <button className="w-[4rem] h-[4rem] rounded-[0.375rem]">...</button>
        <button className="w-[4rem] h-[4rem] rounded-[0.375rem]">20</button>
        <button className="w-[4rem] h-[4rem]">
          <img className="object-contain w-full h-full" src={rightarrow} />
        </button>
      </div>
    </div>
  );
